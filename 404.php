...
if($refuri['host'] == "juiciiyt.github.io/MuneyaTheBot"){
...
echo "If you got here from England, you took a wrong turn at Scotland. And if you got here by typing randomly in the address bar, stop doing that. You're filling my error logs with unnecessary junk.";
}
?>
